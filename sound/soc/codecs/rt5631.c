...
#ifndef DEF_VOL
#define DEF_VOL					0xd6	//0xd4 -30dB 0xc0 0dB
#endif
#ifndef DEF_VOL_SPK
...
static struct rt5631_init_reg init_list[] = {
	...
	{RT5631_STEREO_DAC_VOL_1,	0x0808 },
	...
	{RT5631_SPK_MONO_HP_OUT_CTRL,	0x0000 },	//HP from output-mixer,speaker out from SpeakerOut Mixer
#else
	...
	{RT5631_MIC_CTRL_1,			0x8000 },	//set mic 1 to differential mode
	{RT5631_GPIO_CTRL,			0x0000 },	//set GPIO to input pin
#if defined(CONFIG_HP_JACK_DETECTION_LO)
